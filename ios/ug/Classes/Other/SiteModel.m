...
+ (NSArray *)allSites {
    ...
    dispatch_once(&onceToken, ^{
        ...
        __dataArray = @[
            ...
            site(@"c085",        @"c085hy",       @"165",     @"io.fhpt.H53F348DC",       @"https://c10000ll.com",                        @"企业包",     @"彩壹万"),//已上架    https://c10000ll.com  https://xn--10app-308h91u.com
            ...
            site(@"c216",        @"c216hy",     @"250",     @"io.fhpt.YSAC216",         @"https://www.6510086.com/",                    @"企业包",     @"凤凰彩票"),//
            ...
            site(@"test11",      @"test11",      @"",       @"com.UGGame.cp",             @"http://test11.6yc.com",                       @"内测包",     @"test11"),
            ...
            site(@"test60f",     @"test60f",    @"",        @"com.UGGame.cp",            @"test60f.fhptcdn.com",                        @"内测包",     @"test60f"),//Michael
            site(@"test61f",     @"test61f",    @"",        @"com.UGGame.cp",            @"test61f.fhptcdn.com",                        @"内测包",     @"test61f"),//Michael
            // 站点编号 / 上传编号 / 上传ID / 签名方式 / APP名 / bundleID / 接口域名
