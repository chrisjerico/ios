...
+ (NSArray *)allSites {
    ...
    dispatch_once(&onceToken, ^{
        ...
        __dataArray = @[
            ...
            site(@"c105b",       @"c105bhy",    @"268",     @"io.fhpt.YSAC105B",       @"https://390qp8.com",                            @"超级签名",    @"澳⻔彩票"),          // https://dev.app2.xin/index | 15542484889 | aa168168
            ...
            site(@"test07",      @"",           @"",        @"com.UGGame.chat",         @"http://test07.6yc.com",                       @"内测包",     @"test07"),    // (army)
