...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AvoidCrash-iOS9.0/AvoidCrash.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BAWKWebView-iOS9.0/BAWKWebView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DLPickerView-iOS9.0/DLPickerView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DateTools-iOS9.0/DateTools.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RegExCategories-iOS9.0/RegExCategories.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImage-iOS9.0/SDWebImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SGBrowserView-iOS9.0/SGBrowserView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SGQRCode-iOS9.0/SGQRCode.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSZipArchive/SSZipArchive.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/STPickerView-iOS9.0/STPickerView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TZImagePickerController-iOS9.0/TZImagePickerController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Toast-iOS9.0/Toast.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YYCache-iOS9.0/YYCache.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YYCategories-iOS9.0/YYCategories.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YYImage-iOS9.0/YYImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YYText-iOS9.0/YYText.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YYWebImage-iOS9.0/YYWebImage.framework"
