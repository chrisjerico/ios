...
-(void)setContent:(NSString *)content{
    _content = content;
    NSString *str = _NSString(@"<head><style>body{margin:20;color: red}img{width:auto !important;max-width:%.f;height:auto !important}</style></head><body><text>%@</text></body>", APP.Width-50, _content);
