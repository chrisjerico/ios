...
+ (NSDictionary <NSString *, NSString *>*)allCodePushKey {
    return @{
        @".dev本地代码":@"LocalCode",
        @"_master":@"JaDANqfU11stFA77hHtLK98RpYSY4ksvOXqog",
        @"_master_t":@"HS0UVB2FmZb8yFx1e7GeD0CN7Gh24ksvOXqog",
        @"_fish1":@"8gDdgqhNCZQkMS0CcaSr5oahwpTB4ksvOXqog",
        @"_fish1_t":@"YWG3t0cNiBSbR5fWTR2fV9Vy377q4ksvOXqog",
        @"_tars1":@"xXvZJJSmWwuD9CnMClPp1bzLHl8Y4ksvOXqog",
        @"_tars1_t":@"qhQhyCeI8SiBy178B8KJw8Ofr8oN4ksvOXqog",
        @"_ezer1":@"cNXLOIqJ0JiXGQD55RSBrqpYEqLg4ksvOXqog",
        @"_ezer1_t":@"GyX4k2k0De7hsvAnIOErX3CV0rOR4ksvOXqog",
