...
- (BOOL)pushVCWithUserCenterItemType:(UserCenterItemType)uciType {
    ...
    switch (uciType) {
        ...
        case UCI_银行卡管理: {
            [NavController1 pushViewController:UserI.hasFundPwd ? _LoadVC_from_storyboard_(@"WithdrawalAccountListVC") : _LoadVC_from_storyboard_(@"UGSetupPayPwdController") animated:YES];
            return true;
        }
        case UCI_利息宝: {
            [NavController1 pushViewController:_LoadVC_from_storyboard_(@"UGYubaoViewController")  animated:YES];
