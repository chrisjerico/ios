...
+ (NSArray *)allSites {
    ...
    dispatch_once(&onceToken, ^{
        ...
        __dataArray = @[
            ...
            site(@"c114",        @"c114hy",     @"157",     @"io.fhpt.YSAC114",                        @"https://c432019.com",                                            @"企业包",    @"彩43"),          // https://dev.app2.xin/index | 19859553001 | wenxiang123123
            site(@"c190",        @"c190hy",     @"167",     @"io.fhpt.H5F40948F",       @"https://306565.com",                          @"企业包",    @"22333彩世界"),          // https://dev.app2.xin/index 账号：15559931943   密码：xiaokeai190
            ...
            site(@"c134",        @"c134hy",     @"142",     @"io.fhpt.H5B711E9A",       @"https://19972030.com",                        @"企业包",     @"1997⾹港彩票"),//极光推送 账号xgcp1997@163.com 密码Qaz369369 // 友盟 账号名xiangang 邮箱xgcp1997@163.com 手机13051781273 密码Qaz369369
            ...
            site(@" t126-arc",      @"",          @"",        @"com.UGGame.cp",           @"http://t126f.6yc.com",                    @"内测包",     @"test126"),
            ...
            site(@" t133-smith",    @"",          @"",        @"com.UGGame.cp",           @"t133f.6yc.com",
                 @"内测包",     @"test133"),
            ...
            site(@"test20",      @"test20",     @"263",     @"com.uggame.qp.x",         @"http://t020f.fhptdev.com",                       @"内测包",     @"test20"),    // (朗朗)
            ...
            site(@"test30f",     @"",           @"",        @"com.UGGame.cp",           @"http://test30.fhptdev.com",                  @"内测包",     @"test30"),
            ...
            site(@"t005",        @"t005",       @"241",     @"com.asiapoker.happy.sswc", @"http://t005f.fhptdev.com",                    @"内测包",     @"t005"),
            ...
            site(@"test60f",     @"test60f",    @"275",     @"com.uggame.qp",           @"http://t060f.fhptdev.com",
                 @"内测包",     @"test60f"),//
            site(@"test61f",     @"test61f",    @"276",     @"com.cccaa1",             @"http://t061f.fhptdev.com",                  @"内测包",     @"test61f"),//
            ...
            site(@"testadaf",     @"testadaf",   @"285",     @"com.asiapoker.happy.hd",  @"http://t059f.fhptdev.com",                     @"内测包",     @"testadaf"),    // (ada)t059
