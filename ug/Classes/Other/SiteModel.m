...
+ (NSArray *)allSites {
    ...
    dispatch_once(&onceToken, ^{
        ...
        __dataArray = @[
            ...
            site(@"c001",        @"c001hy",     @"130",     @"io.fhpt.H5BAECCD9",       @"https://47c47webappqp.net",                   @"超级签名",    @"彩47"),          // https://dev.app2.xin/index | 15697023521 | aa135246  | 123456
 ...
 //           site(@"c006",        @"c006hy",     @"151",     @"io.fhpt.H560B7EC1",       @"https://xn--app-v85fh28j.com",                @"企业包",     @"⾦沙娱乐场"),
            ...
            site(@"t103",        @"test103",    @"222",     @"com.UGGame.cp",           @"http://103.9.230.243",                        @"内测包",     @"test103"),
            site(@"t10",         @"88",         @"125",     @"com.UGGame.cp1",          @"http://test10.6yc.com",                       @"内测包",     @"test10"),
            site(@"t11",         @"test11",     @"257",     @"com.ugGame.chat2",        @"http://test11.6yc.com",                       @"内测包",     @"test11"),
            site(@"t111f",       @"c083",       @"226",     @"com.UGGame.chat",         @"http://t111f.fhptcdn.com",                    @"内测包",     @"c083测试"),
            site(@"t100",        @"",           @"",        @"com.UGGame.cp",           @"http://test100f.fhptcdn.com",                 @"内测包",     @"test100"),
            site(@"t03",         @"",           @"",        @"com.UGGame.cp",         @"http://test03.6yc.com",                       @"内测包",     @"test03"),    // (朗朗)
            site(@"t06",         @"",           @"",        @"com.UGGame.cp",         @"http://test06.6yc.com",                       @"内测包",     @"test06"),    // (army)
            site(@"t07",         @"test07",     @"279",     @"com.ug.ChatTest",         @"http://test07.6yc.com",                       @"内测包",     @"test07"),    // (army)
            site(@"t20",         @"test20",     @"263",     @"com.uggame.qp.x",         @"http://test20.6yc.com",                       @"内测包",     @"test20"),    // (朗朗)
            site(@"t21",         @"test21",     @"263",     @"com.jdr.rsaobjc1",        @"http://test21.6yc.com",                       @"内测包",     @"test21"),    // ()
            site(@"t26",         @"test26",     @"326",     @"com.UGGame.cp",           @"http://test26.6yc.com",                       @"内测包",     @"test26"),    // ()
            site(@"t29",         @"test29",     @"245",     @"com.qing.ceshi1",         @"http://test29f.fhptcdn.com",                  @"内测包",     @"test29"),// (小东, ada)
            site(@"t29b",        @"test29b",    @"291",     @"com.guoxiandong.xunliao.x",@"http://t029bz.fhptcdn.com",                  @"内测包",     @"test29b"),// (fly)
            site(@"t30f",        @"",           @"",        @"com.UGGame.cp",           @"http://test30f.fhptcdn.com",                  @"内测包",     @"test30"),
            site(@"t19",         @"test19",     @"214",     @"com.ug.test",             @"http://test19.6yc.com",                       @"内测包",     @"test19"),
            site(@"t31",         @"",           @"",        @"com.UGGame.cp",           @"http://test31.6yc.com",                       @"内测包",     @"test31"),
            ...
            site(@"t36",         @"test36",     @"",        @"com.UGGame.cp",           @"http://test36.6yc.com",                       @"内测包",     @"test36"),//Michael
            site(@"t36a",        @"test36a",     @"",       @"com.UGGame.cp",           @"http://test36a.6yc.com",                      @"内测包",     @"test36a"),//Michael
            site(@"l001gbhy",    @"l001gbhy",   @"252",     @"com.UGGame.cp",           @"https://demo.gbbet.com/",                     @"内测包",     @"港博"),//
            site(@"t60f",        @"test60f",    @"275",     @"com.uggame.qp",           @"http://test60f.fhptcdn.com",                  @"内测包",     @"test60f"),//
            site(@"t61f",        @"test61f",    @"276",     @"com.cccaa1",           @"http://test61f.fhptcdn.com",                  @"内测包",     @"test61f"),//
            site(@"t58f",        @"test58f",    @"282",     @"com.UGGame.cp",           @"http://test58f.ccpt.site",                    @"内测包",     @"test58f"),//
            site(@"t5801",       @"test5801",    @"",      @"com.UGGame.cp",           @"http://test5801.ccpt.site",                    @"内测包",     @"test5801"),//
            site(@"t5802",       @"test5802",    @"",      @"com.UGGame.cp",           @"http://test5802.ccpt.site",                    @"内测包",     @"test5802"),//
            site(@"t5804",       @"test5804",   @"286",     @"com.UGGame.cp",           @"http://test5804.ccpt.site",                   @"内测包",     @"test5804"),
            site(@"t6001",       @"tess6001",   @"",        @"com.UGGame.cp",           @"http://tess6001.fhptcdn.com",                 @"内测包",     @"tess6001"),//
            site(@"t6002",       @"tess6002",   @"",        @"com.UGGame.cp",           @"http://tess6002.fhptcdn.com",                 @"内测包",     @"tess6002"),//
            site(@"t6003",       @"tess6003",   @"",        @"com.UGGame.cp",           @"http://tess6003.fhptcdn.com",                 @"内测包",     @"tess6003"),//
            ...
            site(@"t28f",        @"",           @"",        @"com.UGGame.cp",           @"http://test28f.fhptcdn.com",                  @"内测包",     @"test28f"),
            site(@"tadaf",       @"testadaf",   @"285",     @"com.asiapoker.happy.hd",  @"http://testadaf.fhptcdn.com",                @"内测包",     @"testadaf"),    // (ada)t059
            site(@"t62",         @"test62",     @"289",     @"com.asiapoker.happy.qp650",@"http://test62f.ccpt.site",                   @"内测包",     @"test62"),
            site(@"t09",         @"test09",     @"",        @"com.UGGame.cp",            @"http://test09.6yc.com",                      @"内测包",     @"test09"),
            site(@"t61b",        @"test61bhy",  @"302",     @"com.UGGame.cp",            @"http://test61a.fhptcdn.com",                 @"内测包",     @"test61b"),
            site(@"t61c",        @"test61chy",  @"304",     @"com.UGGame.cp",            @"http://test61c.fhptcdn.com",                 @"内测包",     @"test61c"),
            site(@"t61d",        @"test61Dhy",  @"303",     @"com.UGGame.cp",            @"http://test61d.fhptcdn.com",                 @"内测包",     @"test61d"),
            site(@"t61e",        @"test61Ehy",  @"305",     @"com.UGGame.cp",            @"http://test61e.fhptcdn.com",                 @"内测包",     @"test61e"),
            site(@"t12",         @"test12hy",   @"",        @"com.UGGame.cp",            @"http://test12.6yc.com",                      @"内测包",     @"ttest12"),
			
            site(@"t08",  	    @"test08",     @"",        @"com.UGGame.cp",           @"http://test08.6yc.com",                   @"内测包",     @"test08"),
