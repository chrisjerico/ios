...
+ (NSArray *)allSites {
    ...
    dispatch_once(&onceToken, ^{
        ...
        __dataArray = @[
            ...
            site(@"l002",        @"l002hy",     @"239",     @"io.fhpt.YSAL002",         @"https://70333e.com",                         @"企业包",     @"王中王"),//wang70333@gmail.com   WANGzhongwang70333   极光账号跟密码
            ...
            site(@"c115",        @"c115hy",     @"356",    @"io.fhpt.H59BD7AE3",      @"https://6615322.com",                                            @"企业包",     @"6615中彩网"),
