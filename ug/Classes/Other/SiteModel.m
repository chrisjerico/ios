...
+ (NSArray *)allSites {
    ...
    dispatch_once(&onceToken, ^{
        ...
        __dataArray = @[
            ...
            site(@"c001",        @"c001hy",     @"130",     @"io.fhpt.H5BAECCD9",       @"http://47c47webappqp.info",                   @"超级签名",    @"彩47"),          // https://dev.app2.xin/index | 15697023521 | aa135246  | 123456   该网站域名根本没用，该客户应么有用原生
 ...
 //           site(@"c006",        @"c006hy",     @"151",     @"io.fhpt.H560B7EC1",       @"https://xn--app-v85fh28j.com",                @"企业包",     @"⾦沙娱乐场"),
            ...
            site(@"c246",       @"c246hy",     @"329",      @"io.fhpt.YSAC246",         @"http://647758.com",                         @"企业包",     @"澳门新葡京"),
