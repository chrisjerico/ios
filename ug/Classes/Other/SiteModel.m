...
+ (NSArray *)allSites {
    ...
    dispatch_once(&onceToken, ^{
        ...
        __dataArray = @[
            ...
            site(@"c175",        @"c175hy",     @"148",     @"io.fhpt.H57F31D1D",       @"https://7053i.com",                           @"企业包",     @"太阳城集团"), // 已上架
            ...
            site(@"c116",        @"c116hy",     @"139",     @"io.fhpt.H50A85511",       @"https://13531995.com",                        @"企业包",     @"1353彩世界"),//极光推送，账号：wcai87089@gmail.com密码Csj13530 
            ...
            site(@"c213",        @"c213hy",     @"248",     @"io.fhpt.YSAC213",         @"https://4501110.com",                       @"企业包",     @"450集团"),//
            site(@"c216",        @"c216hy",     @"250",     @"io.fhpt.YSAC216",         @"https://www.6510086.com/",                    @"企业包",     @"凤凰娱乐"),//
            site(@"c217",        @"c217hy",     @"255",     @"io.fhpt.YSFC217",         @"https://9999app-sa5g6erty9r8ujtk5oi9rtg2k6e55uer9999-app.com",   @"企业包",     @"澳门贵宾厅"),//
            ...
            site(@"test07",      @"test07",     @"279",     @"com.UGGame.chat",         @"http://test07.6yc.com",                       @"内测包",     @"test07"),    // (army)
