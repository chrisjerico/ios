...
@interface UGLHMyViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
{
    NSString *skitType;
    NSString *unreadMsg;
}
...
@property (weak, nonatomic) IBOutlet UILabel *userNameLabel;      /**<   用户名称*/
@property (weak, nonatomic) IBOutlet UILabel *userVipLabel;       /**<   用户vip等级*/
...
@property (weak, nonatomic) IBOutlet UILabel *valueLabel;        /**<   成长值 */
...
@property (weak, nonatomic) IBOutlet UIButton *topupButton;       /**<   我的关注 */
@property (weak, nonatomic) IBOutlet UIButton *withdrawalsButton; /**<   我的动态 */
@property (weak, nonatomic) IBOutlet UIButton *conversionButton;  /**<   我的粉丝 */
...
- (void)skinFirstdataSource {
    ...
    if (user.isAgent) {
        [self.menuNameArray addObject:@{@"title" : @"每日签到" , @"imgName" :@"LH_menu-betting1"}];
        [self.menuNameArray addObject:@{@"title" : @"代理申请" , @"imgName" :@"LH_menu-feedback"}];
        [self.menuNameArray addObject:@{@"title" : @"安全中心" , @"imgName" :@"LH_menu-password"}];
        
        [self.menuNameArray addObject:@{@"title" : @"我的银行卡" , @"imgName" :@"LH_bank"}];
        [self.menuNameArray addObject:@{@"title" : @"站内信" , @"imgName" :@"LH_menu-notice"}];
