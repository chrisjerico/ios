...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNReactNativeModalPatch/RNReactNativeModalPatch.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-image-editor/react_native_image_editor.framework"
