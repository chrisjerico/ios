package com.wanxiangdai.commonlibrary.config;
...
public class ProjectConfig {
     ...
     * 程序在手机SDK中的主缓存目录.
     */
    public static final String APP_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + "XJT";
    /**
     * 程序在手机SDK中的缓存目录.
     */
