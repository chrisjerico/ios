...
import com.phoenix.lotterys.my.adapter.NoteRecordAdapterB;
 ...
 * 创建时间: 2019/7/6 20:07
 */
public class NoteRecordFragB extends BaseFragments implements BaseRecyclerAdapter.
    ...
    private NoteRecordAdapterB adapter;
    ...
    public NoteRecordFragB() {
        super(R.layout.note_record_frag_b, true, true);
    }
    ...
    public void initView(View view) {
        ...
        if (type == 2) {
            adapter = new NoteRecordAdapterB(getContext(), list, R.layout.note_record_adapter_b, 5);
        } else {
            adapter = new NoteRecordAdapterB(getContext(), list, R.layout.note_record_adapter_b, tabIndex);
        }
        noteRecordRec.setAdapter(adapter);

        Uiutils.setRec(getContext(), noteRecordRec1, 0);
        adapter1 = new NoteRecordAdapter1(getContext(), list1, R.layout.note_record_adapter_b);
...
//        float toX = lineWidth * position;
        ...
        titles[current_index].setTextColor(getContext().getResources().getColor(R.color.color_white));
