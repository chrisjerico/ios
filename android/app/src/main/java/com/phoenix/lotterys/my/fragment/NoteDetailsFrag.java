 ...
 */
public class NoteDetailsFrag extends BaseFragments implements View.OnClickListener {
    ...
    public NoteDetailsFrag() {
        super(R.layout.note_details_frag, true, true);
    }
    ...
    private void setData() {
        ...
        switch (dataBean.getStatus()) {
            case "0":  //未开将
                ...
                if (null!=dataBean&&dataBean.isAllowMemberCancelBet())
