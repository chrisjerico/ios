...
public class OneLevelAdapter extends RecyclerView.Adapter<OneLevelAdapter.ViewHolder> {
    ...
    int prior = -1;
    String themeColor;
    private OneLevelAdapter.OnClickListener onClickListener;
    private final ConfigBean config;

    public OneLevelAdapter(List<HomeGame.DataBean.IconsBean.ListBean> list, int position, Context context,int item) {
        this.list = list;
    ...
    public void setListener(OneLevelAdapter.OnClickListener onClickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        if (i >= list.size())
            return;
//        ImageLoadUtil.ImageLoad(list.get(i).getIcon(),context,holder.ivTicketIcon,"");
...
//    RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(MeasureUtil.dip2px(context,44),
//            MeasureUtil.dip2px(context,44));
//    params.addRule(RelativeLayout.CENTER_HORIZONTAL);
//    params.setMargins(0,MeasureUtil.dip2px(context,5),0,0);
//    holder.ivTicketIcon.setLayoutParams(params);
        }
...
//                }else if (list.get(i).getTipFlag().equals("2")){
//                    ImageLoadUtil.ImageLoadGif3(list.get(i).getHotIcon(),context,holder.ivRwardHot,R.mipmap.event);
//                    holder.ivRwardHot.setVisibility(View.VISIBLE);
//                } else if (list.get(i).getTipFlag().equals("3")){
//                    ImageLoadUtil.ImageLoadGif3(list.get(i).getHotIcon(),context,holder.ivRwardHot,R.drawable.hots2);
//                    holder.ivRwardHot.setVisibility(View.VISIBLE);
//                }
            }
        }
...
////                    if(!StringUtils.isEmpty(list.get(i).getHotIcon())) {
//                        ImageLoadUtil.ImageLoadGif2(list.get(i).getHotIcon(),context,holder.ivRwardHot);
////                ImageLoadUtil.ImageLoad(context,list.get(i).ge.get(i).getHotIcon()).into(holder.ivRwardHot);
//                        holder.ivRwardHot.setVisibility(View.VISIBLE);
////                    }else {
////                        holder.ivHotHot.setVisibility(View.GONE);
////                        holder.iv_hot.setText("热");
...
//            }
//
//            if (list.get(i).getTipFlag().equals("2")) {
//                if(TextUtils.isEmpty(list.get(i).getHotIcon()))
//                    Glide.with(context).asGif().load(R.mipmap.event).into(holder.ivActivity);
//                else
//                    Glide.with(context).asGif().load(list.get(i).getHotIcon()).into(holder.ivActivity);
//                holder.ivActivity.setVisibility(View.VISIBLE);
//            } else {
//                holder.ivActivity.setVisibility(View.GONE);
//            }
//
//            if (list.get(i).getTipFlag().equals("3")) {
//                if(!TextUtils.isEmpty(list.get(i).getHotIcon())) {
//                    Glide.with(context).asGif().load(list.get(i).getHotIcon()).into(holder.ivRwardHot);
//                    holder.ivRwardHot.setVisibility(View.VISIBLE);
//                }else {
//                    holder.ivRwardHot.setVisibility(View.GONE);
//                    holder.ivRward.setText("大\n奖");
