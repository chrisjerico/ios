 ...
 * on 2019/6/28
 */
public class DepositFragment extends BaseFragments {
    ...
    public void initView(View view) {
        mActivity = (DepositActivity) getActivity();
    ...
    private void getDeposit() {
        ...
        OkGo.<String>get(URLDecoder.decode(Constants.BaseUrl()+Constants.PAYAISLE + SecretUtils.DESede(token)+"&sign="+SecretUtils.RsaToken())).tag(getActivity()).execute(new NetDialogCallBack(getContext(), true, DepositFragment.this, true, PayAisleBean.class) {
            @Override
...
//                            payList.addAll(payAisle.getData().getPayment());
    ...
    public static DepositFragment getInstance(String title) {
        DepositFragment sf = new DepositFragment();
        return sf;
    }
