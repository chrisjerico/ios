 ...
 * 创建时间: 2019/7/6 21:03
 */
public class NoteRecordAdapterB extends BaseRecyclerAdapter<NoteRecordBean.DataBean.ListBean> {

    public NoteRecordAdapterB(Context context, List<NoteRecordBean.DataBean.ListBean> list,
                              int itemLayoutId) {
    ...
    public NoteRecordAdapterB(Context context, List<NoteRecordBean.DataBean.ListBean> list,
        ...
        super(context, list, itemLayoutId);
        this.type=type;
        configBean = (UserInfo) ShareUtils.getObject(context, SPConstants.CONFIGBEAN, UserInfo.class);
    }
