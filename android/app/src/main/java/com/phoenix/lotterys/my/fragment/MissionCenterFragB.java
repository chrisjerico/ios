...
import com.phoenix.lotterys.my.fragment.MissionCenter.AccountingChangeFragB;
import com.phoenix.lotterys.my.fragment.MissionCenter.HappyExchangeFrag;
import com.phoenix.lotterys.my.fragment.MissionCenter.HappyExchangeFragB;
import com.phoenix.lotterys.my.fragment.MissionCenter.MissionHallFrag;
import com.phoenix.lotterys.my.fragment.MissionCenter.MissionHallFragB;
import com.phoenix.lotterys.my.fragment.MissionCenter.VIPLevelFrag;
import com.phoenix.lotterys.my.fragment.MissionCenter.VIPLevelFragB;
...
public class MissionCenterFragB extends BaseFragments {
...
//    FrameLayout framnentLin;
    ...
    @SuppressLint("ValidFragment")
    public MissionCenterFragB(boolean isHide) {
        super(R.layout.mission_center_act_b, true,
                true);
        this.isHide = isHide;
    }
...
//            }
        ...
        list1 = new ArrayList();
        list1.add(new My_item(R.mipmap.ck, getResources().getString(R.string.mission_hall), true));
        ...
        adapter = new MissionCenterAdapter(getContext(), list1, R.layout.mission_center_adapter_b);
...
//            ivTask.setVisibility(View.GONE);
    ...
    private void setViewData() {
        ...
        if (null != userInfo && null != userInfo.getData()) {
            ...
            String text = userInfo.getData().getTaskRewardTotal();
...
//        showPostion(0, listFra);
        ...
        mFragments.add(new MissionHallFragB());
        mFragments.add(new HappyExchangeFragB());
        mFragments.add(new AccountingChangeFragB());
        mFragments.add(new VIPLevelFragB());
...
//                setMyf();
                break;
            case R.id.iv_sign:
                FragmentUtilAct.startAct(getActivity(), new SignInFragB(false));
                break;
            case R.id.tv_money:
