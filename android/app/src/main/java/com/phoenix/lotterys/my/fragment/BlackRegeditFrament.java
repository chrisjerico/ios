 ...
 * on 2019/11/3
 */
public class BlackRegeditFrament extends BaseFragments {
...
//    BlackMainActivity mActivity;
    public static BlackRegeditFrament getInstance() {
        return new BlackRegeditFrament();
    }
    public BlackRegeditFrament() {
        super(R.layout.frament_regedit, true,true);
    }
...
//注册验证
    ...
    @OnClick({R.id.bt_login, R.id.bt_regedit, R.id.bt_gotohome, R.id.bt_phone_code, R.id.rl_img, R.id.tv_agency, R.id.tv_user})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_regedit:
                startActivity(new Intent(getContext(), BlackLoginActivity.class));
//                finish();
//                mActivity.showFrament(6);
                break;
            case R.id.bt_gotohome:
//                startActivity(new Intent(getContext(), BlackLoginActivity.class));
//                finish();
//                mActivity.showFrament(4);
            ...
            case R.id.tv_agency:
                isAgency = true;
                tvAgency.setBackgroundResource(R.drawable.black_reg_backgroup);
            ...
            case R.id.tv_user:
                ...
                tvUser.setBackgroundResource(R.drawable.black1_reg_backgroup);

                tvAgency.setTextColor(getResources().getColor(R.color.black));
