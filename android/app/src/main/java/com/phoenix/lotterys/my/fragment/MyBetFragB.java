 ...
 * 创建时间: 2019/7/8 15:39
 */
public class MyBetFragB extends BaseFragments implements BaseRecyclerAdapter.OnItemClickListener {
    ...
    public MyBetFragB() {
        super(R.layout.my_bet_frag_b, true, true);
    }
    public static MyBetFragB getInstance() {
        MyBetFragB sf = new MyBetFragB();
        return sf;
    }
    @Override
    public void initView(View view) {
        ...
        adapter = new MyBetAdapter(getContext(), list, R.layout.my_bet_adapter_b);
    ...
    public void onItemClick(RecyclerView parent, View view, int position) {
        ...
        FragmentUtilAct.startAct(getActivity(),new NoteDetailsFragB(),bundle);
    }
