...
public class MarqueTextView extends TextView {
    ...
    private int DEFAULT_VERTICAL_INTERVAL = 5000;
    private int DEFAULT_HORIZONTAL_SPEED = 500;     //滚动每个字的时间
    private int DEFAULT_HORIZONTAL_INTERVAL = 4000;
    private int DEFAULT_HORIZONTAL_LOOP_SPEED = 500;  //滚动每个字的时间
...
//    private int textPos = 0; //0,中间  1，上方  -1，下方
    ...
    public String getCurrentShowItem() {
        return this.contentList.get(this.currnetIndex);
    }
