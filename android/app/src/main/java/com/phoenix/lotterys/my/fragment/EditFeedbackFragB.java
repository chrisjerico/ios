 ...
 * 创建时间: 2019/7/5 19:15
 */
public class EditFeedbackFragB extends BaseFragments implements View.OnFocusChangeListener {
    ...
    public EditFeedbackFragB() {
        super(R.layout.edit_feedback_frag_b, true, true);
    }
