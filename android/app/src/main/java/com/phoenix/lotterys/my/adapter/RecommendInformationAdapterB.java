 ...
 */
public class RecommendInformationAdapterB extends BaseRecyclerAdapter<RecommendBenefitBean.DataBean
        .ListBean> {
    ...
    public RecommendInformationAdapterB(Context context, List<RecommendBenefitBean.DataBean
