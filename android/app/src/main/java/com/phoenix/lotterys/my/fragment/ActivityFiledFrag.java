 ...
 * 创建时间: 2019/9/5 13:44
 */
public class ActivityFiledFrag extends BaseFragment {
    ...
    public ActivityFiledFrag() {
        super(R.layout.activity_filed_frag, true, true);
    }
    ...
    public void initView(View view) {
        ...
        ApplyMosaicGoldFrag applyMosaicGoldFrag =new ApplyMosaicGoldFrag();
        ApplyMosaicGoldFrag applyMosaicGoldFrag1 =new ApplyMosaicGoldFrag();
