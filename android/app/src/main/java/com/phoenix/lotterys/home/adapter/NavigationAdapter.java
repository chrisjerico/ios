...
public class NavigationAdapter extends RecyclerView.Adapter<NavigationAdapter.ViewHolder> {
    ...
    private NavigationAdapter.OnClickListener onClickListener;

    public NavigationAdapter(List<GameTypeBean.ListBean> list, Context context) {
        this.list = list;
        this.context = context;
        inflater = LayoutInflater.from(context);
    }

    public void setListener(NavigationAdapter.OnClickListener onClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.item_home_navigat, viewGroup, false);
