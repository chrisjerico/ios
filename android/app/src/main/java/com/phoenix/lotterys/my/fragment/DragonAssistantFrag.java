...
public class DragonAssistantFrag extends BaseFragments implements View.OnClickListener {
...
//    TextView linTex;
    ...
    @SuppressLint("ValidFragment")
    public DragonAssistantFrag(boolean isHide) {
        super(R.layout.dragon_assistant_frag, true, true);
        this.isHide = isHide;
    }

    public static DragonAssistantFrag getInstance(boolean isHide) {
        return new DragonAssistantFrag(isHide);
    }
...
//        fragmentUitl.setFrag();
        ...
        contentview = LayoutInflater.from(getContext()).inflate(R.layout.dragon_assistant_pop,
                null);
        ...
        mFragments.add(MyBetFrag.getInstance());
