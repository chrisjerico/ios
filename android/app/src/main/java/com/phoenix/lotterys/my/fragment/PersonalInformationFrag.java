 ...
 * 创建时间: 2019/7/2 14:50
 */
public class PersonalInformationFrag extends BaseFragments {
    ...
    public PersonalInformationFrag() {
        super(R.layout.personal_information_act, true,
                true);
    }
    ...
    private void setLeftTex() {
        ImageLoadUtil.ImageLoad(getContext(),userInfo.getData().getAvatar(),portraitImg);
        ...
        if(userInfo.getData().getPhone()!=null&& !TextUtils.isEmpty(userInfo.getData().getPhone())){
