 ...
 * 创建时间: 2019/7/5 20:12
 */
public class FeedbackRecordFrag extends BaseFragments implements
    ...
    public FeedbackRecordFrag() {
        super(R.layout.feedback_record_frag, true,
                true);
    }
    ...
    public void initView(View view) {
        ...
        adapter = new FeedbackRecordAdapter(getContext(), list, R.layout.feedback_record_adapter);
...
//                .create();
    ...
    public void onItemClick(RecyclerView parent, View view, int position) {
        ...
        if (view.getId() == R.id.feedback_lin) {
            ...
            FragmentUtilAct.startAct(getActivity(), new FeedbackRecordDetailsFrag(), build);
        } else {
