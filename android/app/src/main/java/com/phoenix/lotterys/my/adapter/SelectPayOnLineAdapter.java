...
public class SelectPayOnLineAdapter extends RecyclerView.Adapter<SelectPayOnLineAdapter.ViewHolder> {
    List<PaymentBean.ChannelBean> list;
    private Context context;
    private LayoutInflater inflater;
    private SelectPayOnLineAdapter.OnClickListener onClickListener;
    private SparseBooleanArray mCheckStates = new SparseBooleanArray();
    private final ConfigBean config;

    public SelectPayOnLineAdapter(List<PaymentBean.ChannelBean> list, Context context) {
        this.list = list;
    ...
    public void setListener(SelectPayOnLineAdapter.OnClickListener onClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.pay_type_item, viewGroup, false);
