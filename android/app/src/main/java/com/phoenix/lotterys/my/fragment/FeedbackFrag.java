...
import com.phoenix.lotterys.my.adapter.FeedbackAdapter;
 ...
 * 创建时间: 2019/7/3 16:26
 */
public class FeedbackFrag extends BaseFragments implements BaseRecyclerAdapter.OnItemClickListener {
    ...
    public FeedbackFrag() {
        super(R.layout.feedback_act, true, true);
    }
    ...
    public void initView(View v ) {
        ...
        FeedbackAdapter adapter = new FeedbackAdapter(getContext(), list, R.layout.feedback_adapter);
    ...
    public void onItemClick(RecyclerView parent, View view, int position) {
            switch (position){
                ...
                case 1:
                    ...
                    FragmentUtilAct.startAct(getActivity(),new EditFeedbackFrag(),bundle);
                    break;
                case 2:
                    Bundle bundle2 =new Bundle();
                    bundle2.putInt("type",2);
                    FragmentUtilAct.startAct(getActivity(),new EditFeedbackFrag(),bundle2);
                    break;
                case 3:
                    FragmentUtilAct.startAct(getActivity(),new FeedbackRecordFrag());
                    break;
            }
    }
}
