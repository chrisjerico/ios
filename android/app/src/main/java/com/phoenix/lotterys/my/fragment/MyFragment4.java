...
import com.phoenix.lotterys.my.adapter.MyFragAdapter3;
...
//    DynamicWave dWave;
    ...
    TextView tvMoney4;
    @BindView(R2.id.refresh_img)
    ImageView refreshImg;
    @BindView(R2.id.tv_money)
    TextView tvMoney;
    @SuppressLint("ValidFragment")
    public MyFragment4(boolean isHide) {
        super(R.layout.fragment_my4, true, true);
        this.isHide = isHide;
    }
    ...
    private MyFragAdapter3 adapter;
...
//            tvMoney4.setText("¥ "+SPConstants.getValue(getContext(), SPConstants.SP_BALANCE));
//            tvMoney1.setText(SPConstants.getValue(getContext(), SPConstants.SP_BALANCE));
            ...
            tvMoney4.setText("¥ "+userInfo.getData().getBalance() == null ? "" : userInfo.getData().getBalance());
...
//            String curlevelint = SPConstants.getValue(getContext(), SPConstants.SP_CURLEVELINT);
    ...
    private void getUserInfo(String s) {
        OkGo.<String>get(URLDecoder.decode(Constants.BaseUrl() + Constants.USERINFO + SecretUtils.DESede(s) + "&sign=" + SecretUtils.RsaToken())).tag(this).execute(new NetDialogCallBack(getContext(), true, MyFragment4.this, true, UserInfo.class) {
            @Override
...
//        }
        ...
        adapter = new MyFragAdapter3(getContext(), list, R.layout.my_frag_adapter3, onItemClickListener);
    ...
    private void initdata(int type) {
        String yuebaoName = SPConstants.getValue(getContext(), SPConstants.SP_YUEBAONAME);
        boolean yuebaoshutdown = SPConstants.getValue(SPConstants.SP_YUEBAOSHUTDOWN, getContext());
        title = getResources().getStringArray(R.array.my_list4);
        titleAlias = getResources().getStringArray(R.array.my_list_alias4);
        icons = getResources().obtainTypedArray(R.array.my_img_list4);
        ...
        Uiutils.setRec(getContext(), rv, 3, R.color.transparent, 1);
        adapter = new MyFragAdapter3(getContext(), list, R.layout.my_frag_adapter3, onItemClickListener);
        rv.setAdapter(adapter);
...
//                mActivity.getVersion();
    ...
    @OnClick({R.id.iv_task, R.id.iv_sign, R.id.tv_money, R.id.refresh_img, R.id.iv_img
            ...
            , R.id.line_conversion_tex, R.id.tv_money1})
...
//                FragmentUtilAct.startAct(getActivity(), new TransferNewFrament(false));
            ...
            case 14:  //安全中心
                ...
                build0.putInt("type", 0);
                build0.putBoolean("isBla", true);
                FragmentUtilAct.startAct(getContext(), new SafetyCenterFragB(false), build0);
                break;
            case 15:  //站内信
            ...
            case 17:  //注单记录
                ...
                FragmentUtilAct.startAct(getActivity(), new NoteRecordFragB(), bundle2);

                break;
            case 18:  //建议反馈
                if (Uiutils.isTourist(getActivity()))
                    return;
                FragmentUtilAct.startAct(getActivity(), new FeedbackFragB());
                break;
            case 19:  //任务中心
                if (Uiutils.isTourist(getActivity()))
                    return;
                ...
                break;
            case 20:  //个人信息
                FragmentUtilAct.startAct(getActivity(), new PersonalInformationFragB());
                break;
            case 21:  //活动彩金
                if (Uiutils.isTourist(getActivity()))
                    return;
    ...
    private Uiutils.OnItemListener onItemClickListener = new Uiutils.OnItemListener() {
        @Override
    ...
    private void transferStatus() {
        ...
        OkGo.<String>get(URLDecoder.decode(Constants.BaseUrl() + Constants.CHECKTRANSFERSTATUS + SecretUtils.DESede(token) + "&sign=" + SecretUtils.RsaToken()))
                .tag(this)
                .execute(new NetDialogCallBack(getContext(), true, MyFragment4.this, true, ToTransferBean.class) {
                    @Override
                    public void onUi(Object o) throws IOException {
                        Log.e("response==", o + "?");
