 ...
 * 创建时间: 2019/7/3 12:56
 */
public class AccountingChangeFrag extends BaseFragments implements OnRefreshListener, OnLoadMoreListener{
    ...
    public AccountingChangeFrag() {
        super(R.layout.accounting_change_frag, true, true);
    }
    ...
    public void initView(View view) {
        ...
        if (StringUtils.isEmpty(nameaa))
        nameaa = getResources().getString(R.string.full_date);
        fullDateTex.setText(R.string.full_date);

        Drawable drawable = getResources().getDrawable(R.drawable.lower_triangle_ash);
        ...
        accountingRec.addItemDecoration(new SpacesItemDecoration(getContext()));
         ...
         adapter = new AccountingChangeAdapter(getContext(), list, R.layout.pubglidstye, 1);
    ...
    private void getData(boolean b) {
        ...
        NetUtils.get(Constants.CREDITSLOG ,map, b, getContext(), new NetUtils.NetCallBack() {
            ...
            public void onSuccess(String object) {
                ...
                if (null != accountingChangeBean && null != accountingChangeBean.getData()
                        &&accountingChangeBean.getData().getTotal()>0
                        &&list.size() != accountingChangeBean.getData().getTotal()) {
...
//        setPopView();
        ...
        popAdapter.setOnItemClickListener(new BaseRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position) {
                nameaa =listDate.get(position).getTitle();
