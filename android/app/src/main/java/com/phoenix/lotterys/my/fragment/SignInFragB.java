...
public class SignInFragB extends BaseFragments implements View.OnClickListener {
    ...
    @SuppressLint("ValidFragment")
    public SignInFragB(boolean isHide) {
        super(R.layout.sign_in_frag_b, true, true);
        this.isHide = isHide;
    }
...
//        ((BaseActivity) getActivity()).initImmersionBar1();
        ...
        popupWindowBuilder = Uiutils.setPopSetting(getContext(), contentView, MeasureUtil.dip2px(getContext()
...
//                        }
    ...
    private void setContentView() {
        contentView = LayoutInflater.from(getContext()).inflate(R.layout.sign_in_frag_pop_b, null);
        ...
        signInPopAdapter = new SignInPopAdapter(getContext(), listPop, R.layout.sign_pop_lay_b);
