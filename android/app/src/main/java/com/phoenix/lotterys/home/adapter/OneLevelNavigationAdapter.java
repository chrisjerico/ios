...
public class OneLevelNavigationAdapter extends RecyclerView.Adapter<OneLevelNavigationAdapter.ViewHolder> {
    List<HomeGame.DataBean.NavsBean> list;
    private Context context;
    private LayoutInflater inflater;
    int pos;
    private QBadgeView badge;
    private OneLevelNavigationAdapter.OnClickListener onClickListener;

    public OneLevelNavigationAdapter(List<HomeGame.DataBean.NavsBean> list, int position, Context context) {
        this.list = list;
    ...
    public OneLevelNavigationAdapter(List<HomeGame.DataBean.NavsBean> navs, Context context) {
        this.list = navs;
        this.context = context;
        inflater = LayoutInflater.from(context);
    ...
    public OneLevelNavigationAdapter(List<HomeGame.DataBean.NavsBean> navs, Context context,boolean isHome) {
        this.list = navs;
        this.isHome = isHome;
        this.context = context;
        inflater = LayoutInflater.from(context);
    ...
    public void setListener(OneLevelNavigationAdapter.OnClickListener onClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.item_home_navig, viewGroup, false);
...
//        if(!TextUtils.isEmpty(list.get(position).getTitle())&&!TextUtils.isEmpty(list.get(position).getName())){
//            if(list.get(position).getTitle().equals("APP下载")){
//                holder.tvName.setText("版本更新");
//            }else
//            holder.tvName.setText(list.get(position).getTitle());
//        }else if(!TextUtils.isEmpty(list.get(position).getTitle())&&TextUtils.isEmpty(list.get(position).getName())){
//            if(list.get(position).getTitle().equals("APP下载")){
//                holder.tvName.setText("版本更新");
//            }else
//                holder.tvName.setText(list.get(position).getTitle());
