 ...
 */
public class FeedbackRecordDetailsFragB extends BaseFragments implements View.OnFocusChangeListener  {
    ...
    public FeedbackRecordDetailsFragB() {
        super(R.layout.feedback_record_details_frag_b, true, true);
    }
    ...
    public void initView(View view) {
        ...
        adapter=new FeedbackRecordDetailsAdapter(getContext(),list,R.layout.feedback_record_details_adapter_b);
