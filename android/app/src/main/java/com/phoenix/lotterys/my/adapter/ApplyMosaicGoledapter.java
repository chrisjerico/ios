 ...
 * 创建时间: 2019/7/3 16:54
 */
public class ApplyMosaicGoledapter extends BaseRecyclerAdapter<ApplyMosaicGoldBean.DataBean.ListBean> {

    public ApplyMosaicGoledapter(Context context, List<ApplyMosaicGoldBean.DataBean.ListBean> list, int itemLayoutId) {
        super(context, list, itemLayoutId);
    }

    private int type;
    public ApplyMosaicGoledapter(Context context, List<ApplyMosaicGoldBean.DataBean.ListBean> list,
