...
import com.phoenix.lotterys.my.adapter.RecommenAdapterB;
import com.phoenix.lotterys.my.adapter.RecommendInformationAdapterB;
...
public class RecommendBenefitFragB extends BaseFragments implements BaseRecyclerAdapter.OnItemClickListener
...
//推荐信息
    ...
    TextView tvSample;
    View mainView ;
    private RecommenAdapterB adapter;

    private RecommendInformationFrag recommendInformationFrag;
    boolean isHide = false;

    @SuppressLint("ValidFragment")
    public RecommendBenefitFragB(boolean isHide) {
        super(R.layout.recommend_benefit_frag_b, true,
                true);
        this.isHide = isHide;
    }

    public static RecommendBenefitFragB getInstance(boolean isHide) {
        return new RecommendBenefitFragB(isHide);
    }
    ...
    public void initView(View view) {
        ...
        adapter = new RecommenAdapterB(getContext(), listProject, R.layout.recommend_adapter_b);
        horizontalRec.setAdapter(adapter);
        adapter.setOnItemClickListener(this);


        dataAdapter = new RecommendInformationAdapterB(getContext(), list, R.layout.pub_recommend_stye_b);
...
//        dataAdapter.setOnItemClickListener(this);
        ...
        contentView = LayoutInflater.from(getContext()).inflate(R.layout.recommend_top_pop_b, null);
        setPoview();

        contentView1 = LayoutInflater.from(getContext()).inflate(R.layout.city_pop, null);
        contentView1.findViewById(R.id.main_lin).setBackgroundColor(getContext().getResources()
    ...
    private RecommendInformationAdapterB dataAdapter;
    private int page = 1;
    private int rows = 20;
