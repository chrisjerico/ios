 ...
 * on 2019/6/11
 */
public class RegeditActivity extends BaseActivitys implements AdvancedWebView.Listener {
    ...
    RelativeLayout rlWx;
    @BindView(R2.id.fl_regedit)
    FrameLayout flRegedit;
...
//    ScrollView sv;
    ...
    @BindView(R2.id.main_lin)//代理注册
            TextView main_lin;
    @BindView(R2.id.d_wave)//代理注册
            DynamicWave d_wave;
    @BindView(R2.id.iv_logo1)
     ImageView ivLogo;
    ...
    public RegeditActivity() {
        super(R.layout.activity_regedit, true, true);
    }
    ...
    public void initView() {
        ...
        flRegedit.setVisibility(View.GONE);
        Uiutils.setBarStye0(titlebar,this);
        if (Uiutils.isTheme(this)) {
            main_lin.setBackground(this.getResources().getDrawable(R.drawable.theme_ba25));
            d_wave.setVisibility(View.INVISIBLE);
        }
        getSupportFragmentManager().beginTransaction()
                .add(R.id.fl_regedit, new SimpleRegeditFrament())
                .commit();
        ...
        if(configBean!=null&&configBean.getData()!=null&&configBean.getData().getMobileTemplateCategory()!=null&&configBean.getData().getMobileTemplateCategory().equals("9")){
            flRegedit.setVisibility(View.VISIBLE);

//            ImageLoadUtil.ImageLoadNoCaching( SPConstants.getValue(this, SPConstants.SP_MOBILE_LOGO), this, ivLogo, 0);
            String urlImg = SPConstants.getValue(this, SPConstants.SP_MOBILE_LOGO);
            Glide.with(RegeditActivity.this).load(urlImg).into(ivLogo);
        }else {
...
//注册验证
    ...
    @OnClick({R.id.bt_login, R.id.bt_regedit, R.id.bt_gotohome,R.id.bt_online_service,
            R.id.bt_phone_code, R.id.rl_img, R.id.tv_agency, R.id.tv_user})
...
//                startActivity(new Intent(this, LoginActivity.class));
    ...
    private void getPhoneCode() {
        ...
        if (mPhone == null || mPhone.length() == 0) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_phone), this);
            return;
        ...
        if (!isMatcherFinded("^1([358][0-9]|4[579]|66|7[0135678]|9[89])[0-9]{8}$", mPhone)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.errorphone), this);
            return;
        }
        ...
        OkGo.<String>post(URLDecoder.decode(Constants.BaseUrl()+Constants.PHONECODE))//
                ...
                .execute(new NetDialogCallBack(this, true, RegeditActivity.this,
                        true, BaseBean.class) {
                    @Override
...
//                        btPhoneCode.setBackgroundResource(R.drawable.backgroup_off);
                            ...
                            ToastUtils.ToastUtils("发送成功", RegeditActivity.this);
                        } else {
                            ToastUtils.ToastUtils("发送失败", RegeditActivity.this);
                        }
    ...
    private boolean checkParamet() throws UnsupportedEncodingException, NoSuchAlgorithmException {
        ...
        if (reco.equals("2") && (mEtAgent == null || mEtAgent.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.agent_id3), RegeditActivity.this);
            return false;
        }

        if (mEtUser == null || mEtUser.length() == 0) {
            ToastUtils.ToastUtils(getResources().getString(R.string.inputuser9), RegeditActivity.this);
            return false;
...
//        }
        ...
        if (mEtPassword == null || mEtPassword.length() == 0) {
            if (passLimit.equals("0")) {
                ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength + "位", RegeditActivity.this);
                return false;
            } else if (passLimit.equals("1")) {
                ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength + getResources().getString(R.string.inputpwdlength1), RegeditActivity.this);
                return false;
            } else if (passLimit.equals("2")) {
                ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength + getResources().getString(R.string.inputpwdlength1) + getResources().getString(R.string.inputpwdlength2), RegeditActivity.this);
                return false;
            }
            ...
            ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength + getResources().getString(R.string.inputpwdlength4), RegeditActivity.this);
            return false;
//            }
        }
        ...
        if (mEtPasswordOnce == null || mEtPasswordOnce.length() == 0) {
            if (passLimit.equals("0")) {
                ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength3) + getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength + "位", RegeditActivity.this);
                return false;
            } else if (passLimit.equals("1")) {
                ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength3) + getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength + getResources().getString(R.string.inputpwdlength1), RegeditActivity.this);
                return false;
            } else if (passLimit.equals("2")) {
                ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength3) + getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength + getResources().getString(R.string.inputpwdlength1) + getResources().getString(R.string.inputpwdlength2), RegeditActivity.this);
                return false;
            }
            ...
            ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength3) + getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength +
                    getResources().getString(R.string.inputpwdlength1), RegeditActivity.this);
            return false;
        } else if (passLimit.equals("2") && !isMatcherFinded(RegexConstants.REGEX, mEtPasswordOnce)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.inputpwdlength3) + getResources().getString(R.string.inputpwdlength) + passLengthSmaill + "位-" + passLength +
                    getResources().getString(R.string.inputpwdlength1) + getResources().getString(R.string.inputpwdlength2), RegeditActivity.this);
            return false;
        }

        if (!mEtPassword.equals(mEtPasswordOnce)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.inputpwd6), RegeditActivity.this);
            return false;
        }

        if (name.equals("2") && (mEtName == null || mEtName.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_name), RegeditActivity.this);
            return false;
        } else if ((name.equals("2") || (name.equals("1") && mEtName.length() != 0)) && mEtName.length() < 2) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_name_lenght), RegeditActivity.this);
            return false;
        }

        if (fundpwd.equals("2") && (mEtPayPwd == null || mEtPayPwd.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_pay_pwd), RegeditActivity.this);
            return false;
        ...
        if (qq.equals("2") && (mEtQq == null || mEtQq.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_QQ), RegeditActivity.this);
            return false;
        }

        if (wx.equals("2") && (mEtWx == null || mEtWx.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_wx), RegeditActivity.this);
            return false;
        }

        if (phone.equals("2") && (mEtPhone == null || mEtPhone.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_phone), RegeditActivity.this);
            return false;
        ...
        if (email.equals("2") && (mEmail == null || mEmail.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_email), RegeditActivity.this);
            return false;
        } else if ((email.equals("2") || (email.equals("1") && mEmail.length() != 0)) && !isEmail(mEmail)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.security_emailerr), RegeditActivity.this);
            return false;
        }


        if (phoCode.equals("1") && (phoneCode == null || phoneCode.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_phone_code), RegeditActivity.this);
            return false;
        } else if (phoCode.equals("1") && phoneCode.length() < 6) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_phone_code_lenght), RegeditActivity.this);
            return false;
        }


        if ((vCode.equals("1") || vCode.equals("3")) && (mEtCode == null || mEtCode.length() == 0)) {
            ToastUtils.ToastUtils(getResources().getString(R.string.input_code), RegeditActivity.this);
            return false;
        ...
        if (gameWebView.getVisibility() == View.VISIBLE) {
            if (nc_sid.equals("") || nc_token.equals("") || nc_sig.equals("")) {
                ToastUtils.ToastUtils(getResources().getString(R.string.verify_err), RegeditActivity.this);
                return false;
            }
        }
                    ...
                    public void onUi(Object o) throws IOException {
                        ...
                        if (rb != null && rb.getCode() == 0) {
                            ...
                            if (rb.getData().isAutoLogin()) {
                                ...
                                ToastUtils.ToastUtils("注册成功", RegeditActivity.this);
//                                startActivity(new Intent(RegeditActivity.this, LoginActivity.class));
                                Uiutils.login(RegeditActivity.this);
                            }
                        } else if (rb != null && rb.getCode() != 0 && rb.getMsg() != null) {
                            ToastUtils.ToastUtils(rb.getMsg(), RegeditActivity.this);
                            if (gameWebView.getVisibility() == View.VISIBLE) {
                                nc_sid = "";
                                nc_token = "";
                                nc_sig = "";
                ...
                .execute(new NetDialogCallBack(this, true, this,
                    ...
                    public void onUi(Object o) throws IOException {
                        ...
                        if (li != null && li.getCode() == 0) {
                            ...
                            startActivity(new Intent(RegeditActivity.this, MainActivity.class));
                        } else if (li != null && li.getCode() != 0 && li.getMsg() != null) {
                            ToastUtils.ToastUtils(li.getMsg(), RegeditActivity.this);
                        }
                    }
    ...
    private void getConfig() {
        OkGo.<String>get(URLDecoder.decode(Constants.BaseUrl()+Constants.CONFIG)).tag(this).execute(new NetDialogCallBack(this, true, this,
                true, ConfigBean.class) {
            @Override
            public void onUi(Object o) throws IOException {
                ConfigBean config = (ConfigBean) o;
                if (config != null && config.getCode() == 0 && config.getData() != null) {
                    ShareUtils.saveObject(RegeditActivity.this, SPConstants.CONFIGBEAN, config);
                    SharedPreferences.Editor edit = sp.edit();
...
//                params.width = Tools.getWidthInPx(getActivity());
                params.height = Uiutils.dipToPx(RegeditActivity.this, 80);
