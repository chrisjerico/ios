...
import com.phoenix.lotterys.my.adapter.MailAdapter;
...
public class MailFrag extends BaseFragments implements BaseRecyclerAdapter.OnItemClickListener,
    ...
    ImageView iv_back;
    @BindView(R2.id.ll_click_all_read)
    ViewGroup llClickAllRead;
    ...
    @SuppressLint("ValidFragment")
    public MailFrag(boolean isHide) {
    ...
    public void initView(View v) {
        ...
        llClickAllRead.setOnClickListener(this);
        ...
        adapter = new MailAdapter(getContext(), list, R.layout.mail_adapter);
    ...
    private void setAllRead() {
        ...
        NetUtils.get(Constants.READ_ALLMSG, httpParams, true, getContext(),
                new NetUtils.NetCallBack() {
                    @Override
                    public void onSuccess(String object) {
                        for (MailFragBean.DataBean.ListBean bean : list) {
                            bean.setIsRead(1);
                        }
                        adapter.notifyDataSetChanged();
                        isRead = true;
