 ...
 * 创建时间: 2019/7/3 12:56
 */
public class MissionHallFragB extends BaseFragments implements
    ...
    public void initView(View view) {
        ...
        adapter = new MissionHallAdapter(getContext(), list, R.layout.mission_hall_adapter_b);
    ...
    private  void  setPop(){
        ...
        if (Uiutils.setBaColor(getContext(),null)){
            ...
            ((TextView)contentView.findViewById(R.id.title_tex)).setTextColor(getContext().getResources()
                    .getColor(R.color.color_white));
            ((TextView)contentView.findViewById(R.id.context_tex)).setTextColor(getContext().getResources()
                    .getColor(R.color.color_white));
            ((TextView)contentView.findViewById(R.id.clear_tex)).setTextColor(getContext().getResources()
                    .getColor(R.color.color_white));
            ((TextView)contentView.findViewById(R.id.commit_tex)).setTextColor(getContext().getResources()
                    .getColor(R.color.color_white));
