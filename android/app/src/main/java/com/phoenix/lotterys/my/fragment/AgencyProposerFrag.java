...
public class AgencyProposerFrag extends BaseFragment implements View.OnClickListener {
    ...
    @SuppressLint("ValidFragment")
    public AgencyProposerFrag(boolean isHide) {
        super(R.layout.agency_proposer_frag, true, true);
        this.isHide = isHide;
    }
