 ...
 * 棋牌 六合模板
 */
public class ChessCardFragment extends BaseFragments {
    ...
    public static ChessCardFragment getInstance() {
        return new ChessCardFragment();
    }

    public ChessCardFragment() {
    ...
    public void initView(View view) {
        ...
        if (StringUtils.isEmpty(getArguments().getString("name")))
...
//                                list.addAll(gameType.getData());
                            ...
                            if (gameType.getData() != null) {
                                ...
                                for (int i = 0; i < gameType.getData().size(); i++) {
                                    if (gameType.getData().get(i).getCategory().equals("card")) {
                                        list.addAll(gameType.getData().get(i).getGames());
                                    }
                                    if (gameType.getData().get(i).getCategory().equals("game")) {
                                        list.addAll(gameType.getData().get(i).getGames());
                                    }
                                    if (gameType.getData().get(i).getCategory().equals("fish")) {
                                        list.addAll(gameType.getData().get(i).getGames());
                                    }
                                }
//                                list.addAll(gameType.getData().get(2).getGames());
//                                list.addAll(gameType.getData().get(4).getGames());
//                                list.addAll(gameType.getData().get(5).getGames());
