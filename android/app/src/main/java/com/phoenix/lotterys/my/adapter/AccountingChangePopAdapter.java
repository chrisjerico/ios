 ...
 * 创建时间: 2019/7/6 21:33
 */
public class AccountingChangePopAdapter extends BaseRecyclerAdapter<My_item> {

    public AccountingChangePopAdapter(Context context, List<My_item> list, int itemLayoutId) {
    ...
    public void convert(BaseRecyclerHolder holder, My_item item, int position, boolean isScrolling) {
        ...
        holder.getView(R.id.rl_main).setVisibility(View.VISIBLE);
