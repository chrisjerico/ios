...
public class SafetyCenterFrag extends BaseFragments implements BaseRecyclerAdapter.
    ...
    @SuppressLint("ValidFragment")
    public SafetyCenterFrag(boolean isHide) {
...
//                startActivity(new Intent(getActivity(), BankManageActivity.class));
    ...
    private String apkUrl =Constants.BaseUrl()+"/lib/google_authenticator/google_android.apk";
