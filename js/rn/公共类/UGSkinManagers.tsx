...
export default class UGSkinManagers {
  ...
  static sysConf(): UGSkinManagers {
    ...
    var skin = UGSkinManagers.all[dict[SysConf1.mobileTemplateCategory]] ?? UGSkinManagers.all.经典1;

    skin.placeholderColor = '#E5E5E5';
    skin.redColor = '#B41C1C';
    return skin;
  }
